...
const REVIEWS: Review[] = [
  {
    id: 1,
    name: 'Sarah Jenkins',
    badge: 'Luxury Villa Host · Unawatuna',
    rating: 5,
    date: '3 days ago',
    text: 'Ananke has been managing our luxury villa linen turnovers in Unawatuna for over a year. The sheets and duvet covers come back snow-white, perfectly pressed, and individually wrapped. Their same-day turnaround during back-to-back guest check-ins is an absolute lifesaver!',
  ...
  },
  {
    ...
    badge: 'Travelers from Italy · 6-week Sri Lanka Trip',
    rating: 5,
    date: '1 week ago',
    text: 'Best laundry service we used in Sri Lanka! We dropped off an 8kg load of cotton shirts, linen trousers, and dresses in the morning, and everything was returned fresh, smelling wonderful, and neatly folded by 5 PM. Fair per-kilo pricing and super friendly staff.',
  ...
  },
  {
    ...
    badge: 'Operations Manager · Boutique Beach Resort',
    rating: 5,
    date: '2 weeks ago',
    text: 'As a boutique resort manager, finding a dependable commercial laundry partner was tough until we contracted Ananke. Consistent high-temperature sanitization, pristine towels, and punctual morning deliveries every single day. Highly recommended for B2B hospitality!',
  ...
  },
  {
    ...
    badge: 'Digital Nomad · Paris / Weligama',
    rating: 5,
    date: '3 weeks ago',
    text: 'Super convenient WhatsApp coordination and express service. I had some delicate silk resort-wear and vintage shirts that I was nervous to wash, but they handled them with utmost care. Everything came back crisp and smelling like clean ocean air!',
  ...
  },
  {
    ...
    rating: 5,
    date: '1 month ago',
    text: 'One of the best laundry services in the Galle area. Most of the 5-star hotels and luxury resorts around Galle to Weligama are their main clients. Outstanding world-class service to both local villa owners and foreign tourists.',
    avatarBg: 'bg-lime-800 text-lime-100',
    avatarText: 'RL',
  },
  {
    id: 6,
    name: 'Liam Macallister',
    badge: 'Australian Expat & Surfer · Midigama',
    rating: 5,
    date: '1 month ago',
    text: 'I have been surfing the south coast for 4 months. Saltwater-soaked towels, sand-filled boardshorts, and stained hoodies all come out spotless every time. Fast, reliable, honest pricing, and they even removed tough sunscreen stains that other laundries could not!',
  ...
  },
  {
    ...
    badge: 'Local Resident · Galle Fort',
    rating: 5,
    date: '1 month ago',
    text: 'The only laundry service in Galle & Unawatuna that I trust with my household linens, curtains, and high-thread-count bedding. The pickup and delivery team is always punctual, courteous, and careful.',
  ...
  },
  {
    ...
    badge: 'Traveler from Sweden · Fort Bazaar Guest',
    rating: 5,
    date: '2 months ago',
    text: 'Dropped off our travel clothes before moving to our next destination. The wash-and-fold service was flawless, neat packaging, and done in under 6 hours. Cleanest scent, zero shrinkage, and wonderful hospitality.',
    avatarBg: 'bg-olive text-white',
    avatarText: 'ML',
  },
  {
    id: 9,
    name: 'Nadeeka Senanayake',
    badge: 'Event & Catering Director · Galle Coast',
    rating: 5,
    date: '2 months ago',
    text: 'We send all our banquet table linens, cloth napkins, and chef uniforms to Ananke Laundry after large wedding receptions. They remove tough curry and wine stains completely. Pristine steam-pressing quality every time!',
    avatarBg: 'bg-cyan-800 text-cyan-100',
    avatarText: 'NS',
  },
  {
    id: 10,
    name: 'Dr. Julian Meyer',
    badge: 'Guest at Amangalla · Munich, Germany',
    rating: 5,
    date: '2 months ago',
    text: 'Exceptional fabric care and very professional service. Prompt pickup directly from our hotel in Galle Fort and returned in immaculate condition within hours. Exceeded all expectations!',
    avatarBg: 'bg-indigo-800 text-indigo-100',
    avatarText: 'JM',
  },
];
